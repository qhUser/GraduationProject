...
<div style="height:20px;"></div>
  ...
  <li role="presentation"><a href="http://localhost:8085/list">正在拍卖</a></li>
  <li role="presentation" ><a href="http://localhost:8087">我的拍卖</a></li>
  <li role="presentation" class="active"><a>拍卖委托</a></li>
  <li role="presentation"><a href="#">拍卖流程</a></li>
  </ul>
  </div>
  <input type="hidden" class="userlevel"><!--隐藏域判定存放用户级别 以及判定用户是否登录 -->
  <input type="hidden" class="userId"><!--隐藏域判定存放用户级别 以及判定用户是否登录 -->
  <div class="col-md-3">
  <form action="/list">
